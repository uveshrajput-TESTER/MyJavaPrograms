...
public class Custom_Exception2 {
    public static void checkage(int a) throws InvalidAgeException_Unchecked_Exceptions {
        if (a<18){
            throw new InvalidAgeException_Unchecked_Exceptions("You are not eligible ");
        }else {
